            ...
            >
              ...
              <div className="p-5 bg-neutral-950 border border-neutral-800 rounded-2xl flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-neutral-400 text-xs leading-relaxed">Need a faster response? Reach out directly via WhatsApp.</p>
                </div>
                <div className="mt-3">
                  <a 
                    href="https://wa.me/" 
              ...
              <div className="p-5 bg-neutral-950 border border-neutral-800 rounded-2xl flex-1 flex flex-col justify-center">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <a href="https://linkedin.com" target="_blank" className="p-2 bg-neutral-900 hover:bg-neutral-800 border border-neutral-800/80 rounded-lg flex items-center gap-2 text-xs text-neutral-300 hover:text-white transition">
                  ...
                  <a href="https://github.com" target="_blank" className="p-2 bg-neutral-900 hover:bg-neutral-800 border border-neutral-800/80 rounded-lg flex items-center gap-2 text-xs text-neutral-300 hover:text-white transition">
                  ...
                  <a href="https://facebook.com" target="_blank" className="p-2 bg-neutral-900 hover:bg-neutral-800 border border-neutral-800/80 rounded-lg flex items-center gap-2 text-xs text-neutral-300 hover:text-white transition">
                  ...
                  <a href="https://instagram.com" target="_blank" className="p-2 bg-neutral-900 hover:bg-neutral-800 border border-neutral-800/80 rounded-lg flex items-center gap-2 text-xs text-neutral-300 hover:text-white transition">
                  ...
                  <a href="https://youtube.com" target="_blank" className="p-2 bg-neutral-900 hover:bg-neutral-800 border border-neutral-800/80 rounded-lg flex items-center gap-2 text-xs text-neutral-300 hover:text-white transition">
                    <svg className="w-3.5 h-3.5 fill-current" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                    YouTube
                  </a>

                  <a href="https://tiktok.com" target="_blank" className="p-2 bg-neutral-900 hover:bg-neutral-800 border border-neutral-800/80 rounded-lg flex items-center gap-2 text-xs text-neutral-300 hover:text-white transition">
